      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbar-collapse">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              <a class="dropdown-item" href="/blog/blog.html">Blog list</a>
              <a class="dropdown-item" href="/blog/blog-3-cols.html">Blog columns</a>
              <a class="dropdown-item" href="/blog/blog-grid.html">Blog grid</a>
              <a class="dropdown-item" href="/blog/blog-sidebar.html">Blog sidebar</a>
              <a class="dropdown-item" href="/blog/blog-masonry.html">Blog masonry</a>
              <a class="dropdown-item" href="/blog/blog-timeline.html">Blog timeline</a>
              <a class="dropdown-item" href="/blog/blog-post.html">Single blog post</a>
              <a class="dropdown-item" href="/blog/blog-post-alt.html">Single blog post 2</a>
              <a class="dropdown-item" href="/blog/blog-post-3.html">Single blog post 3</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <div class="dropdown dropdown-submenu">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="/footer-dark.html#footer">Dark</a>
          ...
          <li class="nav-item dropdown dropdown-extend">
            ...
            <div class="dropdown-menu dropdown-extend-menu" role="menu">
              <div class="row">
                <div class="col-md-3">
                  <a class="dropdown-item" href="/docs/alerts.html"><i class="fa fa-exclamation-triangle"></i> Alerts</a>
                  <a class="dropdown-item" href="/docs/animations.html"><i class="fa fa-magic"></i> Animations</a>
                  <a class="dropdown-item" href="/docs/badges.html"><i class="fa fa-tags"></i> Badges</a>
                  <a class="dropdown-item" href="/docs/buttons.html"><i class="fa fa-paper-plane"></i> Buttons</a>
                  <a class="dropdown-item" href="/docs/button-groups.html"><i class="fa fa-window-restore"></i> Button groups</a>
                  <a class="dropdown-item" href="/docs/cards.html"><i class="fa fa-credit-card"></i> Cards</a>
                </div>
                <div class="col-md-3">
                  <a class="dropdown-item" href="/docs/carousel.html"><i class="fa fa-play-circle"></i> Carousel</a>
                  <a class="dropdown-item" href="/docs/accordion.html"><i class="fa fa-align-justify"></i> Accordion</a>
                  <a class="dropdown-item" href="/docs/cta.html"><i class="fa fa-rocket"></i> Call to action</a>
                  <a class="dropdown-item" href="/docs/dropdowns.html"><i class="fa fa-caret-down"></i> Dropdowns</a>
                  <a class="dropdown-item" href="/docs/forms.html"><i class="fa fa-clipboard"></i> Forms</a>
                  <a class="dropdown-item" href="/docs/input-groups.html"><i class="fa fa-toggle-off"></i> Input groups</a>
                </div>
                <div class="col-md-3">
                  <a class="dropdown-item" href="/docs/icons.html"><i class="fa fa-github-alt"></i> Icons</a>
                  <a class="dropdown-item" href="/docs/list-groups.html"><i class="fa fa-list-alt"></i> List groups</a>
                  <a class="dropdown-item" href="/docs/modals.html"><i class="fa fa-desktop"></i> Modals</a>
                  <a class="dropdown-item" href="/docs/navs.html"><i class="fa fa-location-arrow"></i> Navs</a>
                  <a class="dropdown-item" href="/docs/navbars.html"><i class="fa fa-bars"></i> Navbars</a>
                  <a class="dropdown-item" href="/docs/plugins.html"><i class="fa fa-pencil"></i> New plugins</a>
                </div>
                <div class="col-md-3">
                  <a class="dropdown-item" href="/docs/progress.html"><i class="fa fa-bar-chart" style="transform: rotate(90deg);"></i> Progress bars</a>
                  <a class="dropdown-item" href="/docs/stats-cards.html"><i class="fa fa-line-chart"></i> Stats cards</a>
                  <a class="dropdown-item" href="/docs/tables.html"><i class="fa fa-table"></i> Tables</a>
                  <a class="dropdown-item" href="/docs/typography.html"><i class="fa fa-paint-brush"></i> Typography</a>
                </div>
              </div>
            </div>
